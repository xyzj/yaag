...
<head lang="en">
    <meta charset="UTF-8">
    <title> API Documentation </title>
    <link rel="stylesheet" href="/apirec/yaag/bootstrap.min.css">
    <link href='/apirec/yaag/roboto.css' rel='stylesheet' type='text/css'>
    <!-- Optional theme -->
    <link rel="stylesheet" href="/apirec/yaag/bootstrap-theme.min.css">
    <script src="/apirec/yaag/jquery-2.1.3.min.js"></script>
    <!-- Latest compiled and minified JavaScript -->
    <script src="/apirec/yaag/bootstrap.min.js"></script>
    <style type="text/css">
        body {
            font-family: 'Roboto', sans-serif;
        }
        ...
        hr {
            ...
            border-top: 10px solid rgb(105,105,105);
        }
        .string { color: green; }
        .number { color: darkorange; }
        .boolean { color: blue; }
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">{{.Title}}</a>
            <p class="navbar-text">Document middleware developed by Gophers at <a href="http://betacraft.co">Betacraft</a></p>
        </div>
